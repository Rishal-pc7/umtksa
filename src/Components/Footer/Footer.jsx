...
function Footer() {
  return (
         <div className="relative h-[135vh] md:h-[65vh]  text-white ">
...
<div className="absolute inset-0 bg-gradient-to-b from-brand-blue to-brand-cyan opacity-50"></div>
    ...
    <div className="w-full   px-3 py-4 md:py-10 md:px-32 absolute z-50">
      <div className="flex-col md:flex-row md:gap-x-10 justify-between items-center px-10 hidden md:flex">
          ...
          <h1 className="text-xl md:text-2xl font-bold md:basis-[73%]">Our Products</h1>
      ...
      <div className="flex flex-col md:flex-row justify-center md:justify-start items-start gap-x-10 basis-full md:basis-[73%] ">
         ...
         <ul className="flex flex-col items-start w-full leading-relaxed text-justify mt-5 md:mt-0 text-base md:text-lg" style={{wordBreak:'break-word',whiteSpace:'nowrap'}}>
