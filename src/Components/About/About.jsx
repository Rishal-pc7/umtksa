...
function About() {
  return (
    ...
    <div className="flex w-full flex-wrap md:flex-nowrap gap-x-5 pb-20 text-brand-cyan">
        <div className="w-full md:w-1/2 slider from-left">
        <h1 className='font-extrabold  text-md uppercase'>Who we are</h1>
        ...
        <hr className="w-full border-gray-300 my-4"/>
              <div className="flex flex-col px-4 md:p-4 slider from-left">
              ...
              <div className="flex flex-col mt-5 px-4  md:p-4 slider from-left">
                 <div className="text-blue font-bold text-2xl text-brand-cyan">Our Vision</div>
                 <div className="text-blue font-normal text-lg text-justify text-brand-blue mt- text-br">Our vision is to set the benchmark as the premier provider in the project materials sector, celebrated for our vast selection and exemplary service. We constantly innovate and adapt to client needs, ensuring our solutions are not only relevant but industry-leading. Through a commitment to excellence and customer focus, we’re driven to support the success of every project we supply</div>
             </div>    
