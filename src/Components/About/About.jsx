...
function About() {
  ...
  return (
    ...
    <div className="flex w-full flex-wrap md:flex-nowrap gap-x-5 pb-20 text-brand-cyan" lang='en'>
        <div className="w-full md:w-1/2 md:pr-7 slider from-left">
        <h1 className='font-extrabold  text-lg uppercase'>Who we are</h1>
        <h1 className='font-bold text-justify text-xl md:text-4xl mt-3 md:leading-[3rem] leading-8' style={{textJustify:'distribute',hyphens:'auto'}}>
